...
<div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>成员管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="<?php echo U('Index/adduser');?>" class="actionBtn">添加成员</a>网站成员</h3>
     ...
     <tr>
      ...
      <th align="center">操作</th>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><a href="<?php echo U('Index/userinfo',array('id'=>$vo['id']));?>">编辑</a> | <a href="<?php echo U('Index/delcategory',array('id'=>$vo['id']));?>">删除</a></td>
