...
<!--   <li><a href="<?php echo U('Index/user');?>"><i class="manager"></i><em>民警管理</em></a></li>
    <li><a href="<?php echo U('Index/manager');?>"><i class="manager"></i><em>网站管理员</em></a></li> -->
     <li><a href="<?php echo U('Index/anjian');?>"><i class="manager"></i><em>我的案件</em></a></li>
     <li><a href="<?php echo U('Index/pingjia');?>"><i class="manager"></i><em>同级互评</em></a></li>
     <li><a href="<?php echo U('Index/tousu');?>"><i class="manager"></i><em>我的投诉</em></a></li>
     <li><a href="<?php echo U('Index/qiandao');?>"><i class="manager"></i><em>我的签到</em></a></li>
<!--   <li><a href="<?php echo U('Index/product_category');?>"><i class="productCat"></i><em>商品分类</em></a></li>
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加案件</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="manager.html" class="actionBtn">返回列表</a>添加案件</h3>
            <form action="<?php echo U('Index/addpingjiainfo');?>" method="post">
 ...
 <input type="hidden" name="uid" value="<?php echo ($uid); ?>">
      ...
      <!--  <td width="100" align="right">账号</td>
       <td>
        <input type="text" name="account" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td>
        <input type="password" name="repassword" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
         <tr>
