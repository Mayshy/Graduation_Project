...
<div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>我要投诉</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3>民警投诉</h3>
      ...
      <th align="center">操作</th>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
           ...
           <!--  <td align="center"><?php echo ($vo["account"]); ?></td>
            ...
            <td align="center"><a href="<?php echo U('Index/addtoushu',array('id'=>$vo['id']));?>">投诉 </td>
